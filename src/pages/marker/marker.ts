...
export class MarkerPage {
  ...
  loadMap() {
    let POINTS: BaseArrayClass<any> = new BaseArrayClass<any>([
      ...
      {
        position: {lat:-7.3200345548, lng:112.741225565},
        title: "4",
        iconData: "blue"
      },
      {
        position: {lat:-7.321233433, lng:112.74002011},
        title: "5",
